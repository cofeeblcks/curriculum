<template>
	<div class="info-item">
		<!-- Icon -->
		<CircleIcon :src="item['imageIconUrl'] || item['faIcon'] || 'fa-regular fa-sticky-note'" :type="'standard'" :color="_getItemColor(item)" :text-class="_getItemFontAwesomeTextClass(item)" class="info-item-icon" />
		...
		<div class="info-item-content">
			...
			<ProgressBar v-if="props.descriptionWithProgressBar && item['formattedPercentage']" :percentage="item['value']" :description="item['locales']['description']" :level="item['formattedLevels']" :color="_getProgressBarColor(item)" class="mt-1" />
