<template>
	<div class="image-view">
		<!-- Image -->
		<img ref="img" v-show="isLoaded()" :src="props.src" :alt="props.alt" :class="classList" @load="_onLoad" @error="_onError" />

		<!-- Loading Spinner -->
		<div v-if="props.spinnerEnabled" class="spinner" v-show="!isLoaded()">
			<!-- Base 64 Spinner -->
			<img
				alt="loading..."
				class="preloader-gif"
