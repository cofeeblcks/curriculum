<template>
	<div class="progress-bar-wrapper">
		<!-- Bootstrap Progress -->
		<div class="progress">
			<div class="progress-bar" role="progressbar" :style="style" :aria-valuenow="percentage" aria-valuemin="0" aria-valuemax="100" />
		</div>

		<!-- ProgressBar Description -->
		<div class="progress-description d-flex justify-content-between">
            <div class="text-start">
                <p v-if="props.description" class="text-1 text-description mb-0" v-html="props.description" />
            </div>
            <div class="text-start">
                <p v-if="props.level" class="text-1 text-description mb-0 ml-6" v-html="props.level" />
            </div>
		</div>
	</div>
</template>
